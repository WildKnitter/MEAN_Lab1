        ...
        $.getJSON(
                ...
                function(data) {
                    ...
                    function createDetailTable() {
                        let url = "register.php?teamid=" + chosenDetail +
                        ...
                        let urledit = "detailsteamedit.php?teamid=" + chosenDetail;
                        ...
                        for (let j = 0; j < obj.Members.length; j++) {
                            ...
                            // the unregister page.
                            let urlunreg = "unregister.php?teamid=" + chosenDetail +
                            ...
                            let urlMemEdit = "detailsmemberedit.php?teamid=" + chosenDetail +
                                "&membername=" + obj.Members[j].MemberName +
                                "&memberid=" + obj.Members[j].MemberId +
                                "&email=" + obj.Members[j].Email +
                                "&contactname=" + obj.Members[j].ContactName +
